...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="w-full min-h-screen bg-[var(--bg-surface)] border-t border-[var(--border)] flex flex-col justify-between py-16 px-6 md:px-10 relative"
    ...
    >
      ...
      <div className="max-w-[1400px] w-full mx-auto flex flex-col items-center justify-center text-center my-auto relative z-10 gap-6">
        ...
        >
          ...
          {/* Text Editorial Social links below Get in Touch */}
          <motion.div 
            variants={itemVariants}
      ...
      <div className="max-w-[1400px] w-full mx-auto border-t border-[var(--border)] pt-8 flex items-center justify-center z-10">
        
        {/* Monospace copyright */}
        <span className="font-micro-print text-[11px] text-[var(--text-tertiary)] tracking-wider text-center">
